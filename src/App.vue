...
<template>
  <aside class="solde-or">
    <div>
      <img src="/public/img/piece-or-note.jpg" alt="Solde Or">
      20 000 pièces d'or
    </div>
    <div>
      <img src="/public/img/troupes-icon.png" alt="Troupes">
      0 troupes formées
    </div>
  </aside>
  <header>
    <h1>
      <img src="/public/img/clash-of-clans-logo.webp" alt="Logo Clash of Clans">
    </h1>
    <p class="description">
  ...
  <main>
    <ul class="cartes" v-for="troupe in troupes">
      <li>
        <article>
          ...
          <button :style="'background-color: ' + troupe.couleur + ';'"> Former
            <img src="/public/img/piece-or.png" alt="Former"></button>
